...
public class MunicipalFilteredNotification extends AppCompatActivity {
    private Toolbar toolbar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_municipal_filtered_notification);

        toolbar = findViewById(R.id.notification_filtered_bar_layout);
